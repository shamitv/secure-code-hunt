# Architecture Document — App 35: Compliance Document Tracker
...
3 standalone vulnerabilities (A01 IDOR on documents, A05 debug info leak, A08 eval() deserialization), 2 chains (account_takeover), 3 decoys. Vulnerable endpoints: `GET /api/documents/:id`, `GET /api/admin/debug`, `POST /api/documents`.
